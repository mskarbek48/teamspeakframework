<?php
	...
	class permissionRemovedFromClientChannel  extends AbstractPermissionClientChannel implements EventInvokerInterface, iEventChannel, iEventClient, iEventPermission
	{
