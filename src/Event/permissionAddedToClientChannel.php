<?php
	...
	class permissionAddedToClientChannel extends AbstractPermissionClientChannel implements EventInvokerInterface, iEventChannel, iEventClient, iEventPermission
	{
